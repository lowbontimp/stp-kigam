...
my $start = "2017-01-01T00:00:00" ;
my $end = "2017-02-01T00:00:00" ;
my $minmag = 5.000000 ;
my $maxmag = 10.000000 ;
my $lat = 45.030102 ; 
my $lon = -127.155998 ;
...
while(my $l=<$fh>){
	...
	print "evt $y/$m/$d,$H:$M:$S $c[2] $c[3] $c[4] $c[10]($c[9]) O(-200) O(1800) KG % -- BHZ\n" ;
	print "evt $y/$m/$d,$H:$M:$S $c[2] $c[3] $c[4] $c[10]($c[9]) O(-200) O(1800) KG % -- HHZ\n" ;
}
close($fh) ;
